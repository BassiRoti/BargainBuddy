...
def init_routes(app):
    ...
    def home():
        ...
        print(os.path.abspath("templates/index.html"))  # Debug the path
    ...
    def product_page(product_id):
        ...
        years_to_expiry = product.expiry_year - 2025
        
        years_to_expiry = max(years_to_expiry, 0)
        
        expiry_factor = np.exp(-0.05 * years_to_expiry) * 2  
        
        inventory_factor = min(1.5 * (product.inventory / 100), 1)  
        
        base_discount = maximum_discount * expiry_factor * inventory_factor
        
        predicted_discount = base_discount
